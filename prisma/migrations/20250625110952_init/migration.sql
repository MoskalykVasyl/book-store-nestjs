...
-- CreateEnum
CREATE TYPE "AuthMethod" AS ENUM ('CREDANTIALS', 'GOOGLE');

-- CreateEnum
CREATE TYPE "TokenType" AS ENUM ('VERIFICATION', 'TWO_FACTOR', 'PASSWORD_RESET');

-- CreateEnum
CREATE TYPE "Genre" AS ENUM ('Fantasy', 'Mystery', 'Horror', 'RomanceNovel', 'Biography', 'Detective');
...
CREATE TABLE "books" (
    ...
    "year_publication" TIMESTAMP(3) NOT NULL,
